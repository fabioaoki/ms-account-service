...
public final class TopicValidationConstants {
    ...
    public static final String MESSAGE_PROFILE_TYPE_NOT_LINKED_TO_ACCOUNT =
            "The given profile type is not linked to this account.";
    ...
    public static final String MESSAGE_PROFILE_TYPE_REQUIRED_WHEN_END_DATE_PRESENT =
            "profileType must be present in the request body when endDate is sent.";

    public static final String MESSAGE_ANNOTATOR_TOPIC_CANNOT_SEND_END_DATE =
            "Topics with ANNOTATOR profile must not include endDate in the request body.";

    public static final String MESSAGE_END_DATE_REQUIRED_FOR_NON_ANNOTATOR_TOPIC =
            "endDate is required for non-ANNOTATOR profiles.";

    public static final String MESSAGE_END_DATE_MUST_NOT_BE_BEFORE_CREATION =
            "endDate must not be before the topic creation time.";

    public static final String MESSAGE_END_DATE_MUST_NOT_EXCEED_CREATION_PLUS_MAX_DAYS =
            "endDate must be on or before creation time plus %d days (same time on that day is allowed).";
    ...
    public static final String MESSAGE_ANNOTATOR_TOPIC_UPDATE_FORBIDDEN_FIELDS =
            "ANNOTATOR topic updates must not include context, profileType, or endDate.";
    ...
    public static final String MESSAGE_TOPIC_UPDATE_AT_LEAST_ONE_FIELD =
            "At least one of title, context, profileType, endDate must be present in the update body.";
    ...
    public static final String MESSAGE_ANNOTATOR_TOPIC_LIST_CANNOT_COMBINE_WITH_STATUS_FILTER =
            "Invalid list filters: ANNOTATOR topics have no persisted status; do not send status together with profileType ANNOTATOR.";
    ...
    public static final String MESSAGE_TOPIC_HAS_NO_ANNOTATOR_RESUMES_FOR_AI =
            "No annotator link history rows with non-empty resume for this topic; nothing to consolidate.";
    ...
    public static final String MESSAGE_TOPIC_OWNER_ACCOUNT_ID_MISMATCH =
            "topicOwnerAccountId must match accountId in the path.";
