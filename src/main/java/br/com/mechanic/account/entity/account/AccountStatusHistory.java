...
@AllArgsConstructor
@Entity
@Table(name = EntityConstants.ACCOUNT_STATUS_HISTORY_TABLE_NAME)
public class AccountStatusHistory {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = EntityConstants.ACCOUNT_STATUS_HISTORY_ACCOUNT_FK_NAME)
    )
    private Account account;

    @Column(name = EntityConstants.COLUMN_ACCOUNT_STATUS_HISTORY_OCCURRED_AT, nullable = false)
