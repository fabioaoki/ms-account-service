...
@AllArgsConstructor
@Entity
@Table(name = EntityConstants.ACCOUNT_PROFILE_TABLE_NAME)
public class AccountProfile {
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = EntityConstants.ACCOUNT_PROFILE_ACCOUNT_FK_NAME)
    )
    ...
    @JoinColumn(
            ...
            nullable = false,
            foreignKey = @ForeignKey(name = EntityConstants.ACCOUNT_PROFILE_PROFILE_FK_NAME)
    )
